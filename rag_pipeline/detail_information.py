...
class BorrowerInformation(BaseModel):
    ...
    borrower_name: Optional[str] = Field(None, description="The full name of the REFINED CONTOUR SDN BHD, if more than one seperate them by commas ")
    ...
    borrower_address: Optional[str] = Field(None, description="The full address of the REFINED CONTOUR SDN BHD ")
