...
class BorrowerInformation(BaseModel):
    ...
    borrower_name: Optional[str] = Field(None, description="The full name of the Play Interactive Sdn. Bhd.")
    borrower_registeration_number: Optional[str] = Field(None, description="The full Registration No. of the Play Interactive Sdn. Bhd.")
    borrower_address: Optional[str] = Field(None, description="The full bussiness address of the Play Interactive Sdn. Bhd.")
