...
class BorrowerInformation(BaseModel):
    ...
    borrower_name: Optional[str] = Field(None, description="The full name of the LIM PHIANG KEE @ LIM SEOW MEI, if more than one seperate them by commas ")
    ...
    borrower_address: Optional[str] = Field(None, description="The full address of the LIM PHIANG KEE @ LIM SEOW MEI ")
