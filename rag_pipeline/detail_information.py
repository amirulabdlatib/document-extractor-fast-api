...
class BorrowerInformation(BaseModel):
    ...
    borrower_name: Optional[str] = Field(None, description="The full name of the Gary Lim Chee Kiong and Ong Lian Hong, if more than one seperate them by commas ")
    ...
    borrower_address: Optional[str] = Field(None, description="The full address of the Gary Lim Chee Kiong and Ong Lian Hong ")
