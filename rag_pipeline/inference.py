...
def extract_information(docs:list):
    ...
    questions_and_models = [
        ("What is the Ah Cheng Laksa Sdn Bhd information?", BorrowerInformation, "transformed_files/X-SSM AH CHENG LAKSA TRADING SDN. BHD.  030425_page_1_extracted_transformed.txt"), 
        ("What is the bank information?", BankInformation, "transformed_files/ACL Offer letter - 1_page_1_extracted_transformed.txt"), 
        ("What is the loan information?", LoanInformation, "transformed_files/ACL Offer letter - 1_page_1_extracted_transformed.txt"),
        ("What is the Guarantees information?", GuarantorInformation, "transformed_files/ACL Offer letter - 1_page_7_extracted_transformed.txt"), 
        ("What is the law firm information?", LawFirmInformation, "transformed_files/ACL Offer letter - 1_page_1_extracted_transformed.txt")
    ]
