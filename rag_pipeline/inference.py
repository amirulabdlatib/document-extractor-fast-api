...
def extract_information(docs:list):
    ...
    questions_and_models = [
        ("What is the ANJURAN SENTOSA SDN. BHD. information?", BorrowerInformation, "transformed_files/26785_Copy LO_page_1_extracted_transformed.txt"), 
        ("What is the bank information?", BankInformation, "transformed_files/26785_Copy LO_page_1_extracted_transformed.txt"), 
        ("What is the loan information?", LoanInformation, "transformed_files/26785_Copy LO_page_1_extracted_transformed.txt"),
        ("What is the facility information?", FacilityInformation, "transformed_files/26785_Copy LO_page_2_extracted_transformed.txt"),
        ("What is the property information?", PropertyInformation, "transformed_files/26785_Copy LO_page_2_extracted_transformed.txt"),
        ("Formulate is the title description", TitleInformation, "transformed_files/26785_Copy LO_page_1_extracted_transformed.txt"), # to be fixed later
        ("What is the Guarantees information?", GuarantorInformation, "transformed_files/26785_Copy LO_page_2_extracted_transformed.txt"), 
        ("What is the law firm information?", LawFirmInformation, "transformed_files/26785_Copy LO_page_1_extracted_transformed.txt"),
    ]
