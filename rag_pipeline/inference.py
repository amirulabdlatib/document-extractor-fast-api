...
def extract_information(docs:list):
    ...
    questions_and_models = [
        ("What is the SAINT IMAGE GRAPHICS SDN. BHD. information?", BorrowerInformation, "transformed_files/26719-LO (stmpd)_page_1_extracted_transformed.txt"), 
        ("What is the bank information?", BankInformation, "transformed_files/26719-LO (stmpd)_page_1_extracted_transformed.txt"), 
        ("What is the loan information?", LoanInformation, "transformed_files/26719-LO (stmpd)_page_1_extracted_transformed.txt"),
        ("What is the facility information?", FacilityInformation, "transformed_files/26719-LO (stmpd)_page_1_extracted_transformed.txt"),
        ("What is the property information?", PropertyInformation, "transformed_files/26719-LO (stmpd)_page_5_extracted_transformed.txt"),
        ("Formulate is the title description", TitleInformation, "transformed_files/26719-LO (stmpd)_page_1_extracted_transformed.txt"),
        ("What is the Guarantees information?", GuarantorInformation, "transformed_files/26719-LO (stmpd)_page_5_extracted_transformed.txt"), 
        ("What is the law firm information?", LawFirmInformation, "transformed_files/26719-LO (stmpd)_page_4_extracted_transformed.txt"),
    ]
