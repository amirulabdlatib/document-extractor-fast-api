...
def extract_information(docs:list):
    ...
    questions_and_models = [
        ("What is the REFINED CONTOUR SDN BHD  information?", BorrowerInformation, "transformed_files/LO (1)_page_1_extracted_transformed.txt"), 
        ("What is the bank information?", BankInformation, "transformed_files/LO (1)_page_1_extracted_transformed.txt"), 
        ("What is the loan information?", LoanInformation, "transformed_files/LO (1)_page_1_extracted_transformed.txt"),
        ("What is the facility information?", FacilityInformation, "transformed_files/LO (1)_page_1_extracted_transformed.txtt"),
        ("What is the property information?", PropertyInformation, "transformed_files/LO (1)_page_4_extracted_transformed.txt"),
        ("Formulate is the title description", TitleInformation, "transformed_files/LO (1)_page_5_extracted_transformed.txt"),
        ("What is the Guarantees information?", GuarantorInformation, "transformed_files/LO (1)_page_2_extracted_transformed.txt"), 
        ("What is the law firm information?", LawFirmInformation, "transformed_files\LO (1)_page_2_extracted_transformed.txt"),
    ]
